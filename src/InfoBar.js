    ...
    <div className="InfoBar container-fluid bg-dark row justify-content-between pb-5 pt-2">
      ...
      <div className="col-10 col-lg-4 bg-dark p-3 mx-5">
        <ul class="list-group list-group-flush bg-dark">
          ...
          <li class="list-group-item bg-dark text-white"><a href="mailto:contact@InRoll.com" class="text-white text-decoration-none"><i class="bi bi-envelope-fill text-white fs-5">contact@InRoll.com</i> </a></li>
